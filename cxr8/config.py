...
parser.add_argument('--batch_size', default=12, type=int, help="Batch size while training")
...
parser.add_argument('--global_pool', default='MAX', type=str, help="Global Pooling method [LSE,AVG,MAX]")
parser.add_argument('--backbone', default='densenet121', type=str,
